...
declare("Scheduler", CS.Spark.Scheduler)
declare("SparkTween", CS.SparkTween)
declare("Spark", CS.Spark)
declare("Tweening", CS.Spark.Tweening)
declare("DelayCallLua", CS.Spark.DelayCallLua)

declare("Event", require("LuaFrame.Event"))
declare("EventManager", require("LuaFrame.EventManager"))
declare("logError", logError)
